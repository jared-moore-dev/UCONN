...
void sortUnion(Variant * tUnionArray, int n) {
  ...
  qsort(tUnionArray, n, sizeof(tUnionArray[0]),compUnion); // not sure if this will work
...
// TODO. Don't forget to compare the magnitude.
...
int compareUnionAscending(const void * tagged_union1, const void * tagged_union2, void * fun_ptrs) {
  ...
  /*
    TODO: Fill this in. 
   */
  VarFun* fpts = (VarFun*)fun_ptrs;
  return fpts[tU1->tag](tU1, tU2);
}
